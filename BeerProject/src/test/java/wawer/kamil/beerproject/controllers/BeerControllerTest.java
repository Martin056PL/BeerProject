...
public class BeerControllerTest {
    ...
    @Test
    public void should_return_status_ok_when_controller_returns_some_beer_page_base_on_brewery_id() throws ElementNotFoundException {
    ...
    @Test
    public void should_return_status_ok_when_controller_returns_some_beer_list_base_on_brewery_id() throws ElementNotFoundException {
    ...
    @Test
    public void should_return_response_body_equal_to_controller_response_with_some_beer_base_on_beer_id() throws ElementNotFoundException {
    ...
    @Test
    public void should_return_status_ok_when_controller_returns_beer_base_on_beer_id() throws ElementNotFoundException {
        when(mapper.map(service.findBeerByBeerId(beerID), BeerDTO.class)).thenReturn(beerDTO);
        assertEquals(HttpStatus.OK, beerController.findProperBeerByBeerId(beerID).getStatusCode());
    }

    @Test(expected = ElementNotFoundException.class)
    public void should_throw_exception_when_controller_did_not_found_beer_base_on_id() throws ElementNotFoundException {
        when(service.findBeerByBeerId(beerID)).thenThrow(ElementNotFoundException.class);
        beerController.findProperBeerByBeerId(beerID);
    }

    @Test
    public void should_return_response_body_equal_to_controller_response_with_some_beer_base_on_brewery_id_and_beer_id() throws ElementNotFoundException {
    ...
    @Test
    public void should_return_status_ok_when_controller_returns_some_beer_base_on_brewery_id_and_beer_id() throws ElementNotFoundException {
        when(mapper.map(service.findProperBeerByBreweryIdAndBeerId(breweryID, beerID), BeerDTO.class)).thenReturn(beerDTO);
        assertEquals(HttpStatus.OK, beerController.findProperBeerBaseOnBreweryIdAndBeerId(breweryID, beerID).getStatusCode());
    }

    @Test(expected = ElementNotFoundException.class)
    public void should_throw_exception_when_controller_did_not_found_beer_base_on_brewery_id_or_beer_id() throws ElementNotFoundException {
        when(service.findProperBeerByBreweryIdAndBeerId(breweryID, beerID)).thenThrow(ElementNotFoundException.class);
    ...
    @Test
    public void should_return_response_body_equal_to_controller_response_with_just_created_beer_base_on_request_body_beer_and_brewery_id() throws ElementNotFoundException, URISyntaxException {
    ...
    @Test
    public void should_return_status_created_when_controller_successfully_add_beer_base_on_request_body_beer_and_brewery_id() throws ElementNotFoundException, URISyntaxException {
        when(mapper.map(beerDTO, Beer.class)).thenReturn(beer);
        when(service.addNewBeerAssignedToBreweryByBreweryId(breweryID, mapper.map(beerDTO, Beer.class))).thenReturn(beer);
        when(mapper.map(beer, BeerDTO.class)).thenReturn(beerDTO);
    ...
    @Test(expected = ElementNotFoundException.class)
    public void should_throw_exception_when_controller_did_not_found_brewery_base_on_brewery_id_during_add_new_beer() throws ElementNotFoundException, URISyntaxException {
        when(mapper.map(beerDTO, Beer.class)).thenReturn(beer);
        when(service.addNewBeerAssignedToBreweryByBreweryId(breweryID, mapper.map(beerDTO, Beer.class))).thenThrow(ElementNotFoundException.class);
    ...
    @Test
    public void should_return_response_body_equal_to_controller_response_with_just_updated_beer_base_on_request_body_beer_and_beer_id() throws ElementNotFoundException {
        when(mapper.map(beerDTO, Beer.class)).thenReturn(beer);
    ...
    @Test
    public void should_return_status_ok_when_controller_successfully_updated_beer_base_on_request_body_beer_and_beer_id() throws ElementNotFoundException {
        when(mapper.map(beerDTO, Beer.class)).thenReturn(beer);
        when(service.updateBeerByBeerId(beerID, mapper.map(beerDTO, Beer.class))).thenReturn(beer);
        when(mapper.map(beer, BeerDTO.class)).thenReturn(beerDTO);
    ...
    @Test(expected = ElementNotFoundException.class)
    public void should_throw_exception_when_there_is_no_beer_base_on_id_during_updating_beer() throws ElementNotFoundException {
        when(mapper.map(beerDTO, Beer.class)).thenReturn(beer);
        when(service.updateBeerByBeerId(beerID, mapper.map(beerDTO, Beer.class))).thenThrow(ElementNotFoundException.class);
        beerController.updateBeer(beerID, beerDTO);
    }

    @Test
    public void should_return_response_body_equal_to_controller_response_with_just_updated_beer_base_on_request_body_beer_and_beer_id_and_brewery_id() throws ElementNotFoundException {
        when(mapper.map(beerDTO, Beer.class)).thenReturn(beer);
    ...
    @Test
    public void should_return_return_status_ok_when_controller_successfully_updated_beer_base_on_request_body_beer_and_beer_id_and_brewery_id() throws ElementNotFoundException {
        when(mapper.map(beerDTO, Beer.class)).thenReturn(beer);
        when(service.updateBeerByBreweryIdAndBeerId(breweryID, beerID, mapper.map(beerDTO, Beer.class))).thenReturn(beer);
        when(mapper.map(beer, BeerDTO.class)).thenReturn(beerDTO);
    ...
    @Test(expected = ElementNotFoundException.class)
    public void should_throw_exception_when_there_is_no_beer_base_on_beer_id_or_brewery_id_during_updating_beer() throws ElementNotFoundException {
        when(mapper.map(beerDTO, Beer.class)).thenReturn(beer);
        when(service.updateBeerByBreweryIdAndBeerId(breweryID, beerID, mapper.map(beerDTO, Beer.class))).thenThrow(ElementNotFoundException.class);
    ...
    @Test
    public void should_return_status_no_content_when_controller_successfully_delete_beer_base_on_beer_id() throws ElementNotFoundException {
        assertEquals(ResponseEntity.noContent().build(), beerController.deleteBeerByBeerId(beerID));
    }

    @Test
    public void should_return_status_no_content_when_controller_successfully_delete_beer_base_on_beer_id_and_brewery_id() throws ElementNotFoundException {
    ...
    @Test
    public void should_return_status_ok_when_controller_successfully_add_image_for_brewery() throws IOException, ElementNotFoundException, InvalidImageParameters {
    ...
    @Test
    public void should_return_status_ok_when_controller_successfully_download_image_for_brewery() throws ElementNotFoundException {
