...
1. Ability to register new user (functional)
2. Sending emails to user, including emails with confirmation (functional)
3. Getting and managing breweries and beers (functional)
4. Getting and managing users existing within application and their privileges (technical)
5. User authentication via login endpoint (functional)
6. Implemented gathering logs mechanism (technical)
7. Implemented auditing for data (technical)
8. Implemented version control system for DB (technical)
9. Added dockerfile and docker-compose to run app (technical)
10. Added code validator to measure code coverage and detects codesmells (technical)
...
- Modify CustomRevisionListener and auditorProvider by getting auditor from JWT token.
